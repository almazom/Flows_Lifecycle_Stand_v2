...
changes_from_6_5_2:
  - hard-09: preflight extended with secret_leak_gate and ci_test_safety_gate
  - hard-10: phase 2 async-blocking anti-pattern detection required
  - hard-11: agent profile fallback attestation added to prevent runtime profile stalls
  - hard-12: pilot satisfaction guard integrated for stable promotion scoring
