...
changes_from_6_5_1:
  - hard-01: canonical 15-item artifact set aligned with artifact_minimality guard
  - hard-02: implementation-first mode policy with explicit analysis_only opt-in
  - hard-03: phase 1 dynamic expert selection algorithm formalized (top-6 + fallback)
  - hard-04: phase 2 strict six-expert dispatch evidence added
  - hard-05: Trello template dual-path resolution added (03 path + fallback path)
  - hard-06: card required sections aligned to 15-point scoring model
  - hard-07: auto-commit phase naming aligned to 4a/4b
  - hard-08: SSOT schema version updated to 6.5.2
