...
- `flow_version_lock_gate` — active START = v6.5.4, symlink valid
...
changes_from_6_5_3:
  - hard-13: step_coverage hard-fail invariants formalized
  - hard-14: deterministic secret gate fail policy strengthened
  - hard-15: quorum schema enforcement includes quorum_met evidence
  - hard-16: auto-commit canonical phase and non-pending SHA validation added
  - hard-17: requirements_backlog_traceability guard added for unmapped finding prevention
  - hard-18: phase-8 SSOT↔card status sync rule added
